...
import fondo from '../assets/yoga.jpg'
...
export default function Yoga({ navigation }) {
    ...
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Yoga' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));

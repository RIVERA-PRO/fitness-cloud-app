...
import fondo from '../assets/Banda.jpg'
import Icon from 'react-native-vector-icons/MaterialIcons';
import { LinearGradient } from 'expo-linear-gradient';
import { MaterialIcons } from '@expo/vector-icons';
import { Animated, Easing } from 'react-native';
import { useFocusEffect } from '@react-navigation/native';
export default function Banda_elastica({ navigation }) {
    const [searchText, setSearchText] = useState('');
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Banda_elastica' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));

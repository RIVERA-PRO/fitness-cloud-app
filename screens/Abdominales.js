...
import fondo from '../assets/abdominales.jpg'
import Icon from 'react-native-vector-icons/MaterialIcons';
import { LinearGradient } from 'expo-linear-gradient';
import { MaterialIcons } from '@expo/vector-icons';
import { Animated, Easing } from 'react-native';
import { useFocusEffect } from '@react-navigation/native';
export default function Abdominales({ navigation }) {
    const [searchText, setSearchText] = useState('');
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Abdominales' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));

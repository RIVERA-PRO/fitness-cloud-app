...
import fondo from '../assets/pecho.jpg'
...
export default function Pecho({ navigation }) {
    ...
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Pecho' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));

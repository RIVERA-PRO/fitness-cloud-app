...
import fondo from '../assets/cardio.jpg'
...
export default function Cardio({ navigation }) {
    ...
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Cardio' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));

...
import cardioImg from '../assets/biceps.jpg'
export default function Biceps({ navigation }) {
    const [searchText, setSearchText] = useState('');
    const bicepsExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Biceps' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));
    ...
    return (
        <ImageBackground source={cardioImg} resizeMode="cover">
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.seccion}>
                    <View style={styles.titleCantidad}>
                        <Text style={styles.textoTitle}>Ejercicios de Biceps</Text>
                        <Text style={styles.textoCantidad}>{bicepsExercises.length}</Text>
                    </View>
                    <TextInput

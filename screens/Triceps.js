...
import fondo from '../assets/triceps3.jpeg'
...
export default function Triceps({ navigation }) {
    ...
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Triceps' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));

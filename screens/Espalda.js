...
import fondo from '../assets/espalda.jpg'
...
export default function Espalda({ navigation }) {
    ...
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Espalda' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));

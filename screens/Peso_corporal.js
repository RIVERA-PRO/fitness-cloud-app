...
import fondo from '../assets/pesocorporal.jpg'
...
export default function PesoCorporal({ navigation }) {
    ...
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Peso_corporal' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));

...
import fondo from '../assets/cuadriceps.jpg'
...
export default function Cuadriceps({ navigation }) {
    ...
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Cuadriceps' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));
                                ...
                                <LinearGradient colors={['#D71920', '#AC1929',]} style={styles.exerciseContent}
                                    ...
                                    <View style={styles.deFlexColumn}>
                                        {exercise.title.length > 30 ? (
                                            <Text style={styles.exerciseName}>{exercise.title.slice(0, 30)}...</Text>
                                        ) : (

...
import fondo from '../assets/gluteos.jpg'
...
export default function Gluteos({ navigation }) {
    ...
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Gluteos' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));

...
export default function Cardio({ navigation }) {
    ...
    const showNoResults = cardioExercises.length === 0;
    return (
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            ...
            <View style={styles.imgBg}>
                <Image source={cardioImg} style={styles.img} />
            </View>
            ...
            <View style={styles.seccion}>
                ...
                <View style={styles.titleCantidad}>
                    <Text style={styles.textoTitle}>Ejercicios de Cardio</Text>
                    <Text style={styles.textoCantidad}>{cardioExercises.length}</Text>
                </View>

...
import hombrosImg from '../assets/hombro.png'
import Icon from 'react-native-vector-icons/MaterialIcons';
import { LinearGradient } from 'expo-linear-gradient';
export default function Hombros({ navigation }) {
    const [searchText, setSearchText] = useState('');
    const hombrosExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Hombros' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));

    const goToDetail = (exerciseId) => {
        navigation.navigate('Detail', { exerciseId });
    };
    const showNoResults = hombrosExercises.length === 0;
    return (
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            ...
            <View style={styles.imgBg}>
                <Image source={hombrosImg} style={styles.img} />
            </View>
            ...
            <View style={styles.seccion}>
                ...
                <View style={styles.titleCantidad}>
                    <Text style={styles.textoTitle}>Ejercicios de Hombros</Text>
                    <Text style={styles.textoCantidad}>{hombrosExercises.length}</Text>
                </View>

...
import fondo from '../assets/hombro.png'
...
export default function Hombros({ navigation }) {
    ...
    const selectExercises = ejerciciosData.filter(exercise => exercise.categoria === 'Hombros' && exercise.title.toLowerCase().includes(searchText.toLowerCase()));
